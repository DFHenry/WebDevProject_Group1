...
$query = 'SELECT order_id, event_date, guest_count, event_type, is_delivery, delivery_address, special_instructions, order_status FROM catering_orders WHERE user_id = ? AND order_id = ? LIMIT 1';
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($item['order_id']) ?></li>
  </ol>
</nav>

<h1 class="mb-3"><?= htmlspecialchars($item['order_id']) ?></h1>
